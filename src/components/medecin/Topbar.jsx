      ...
      <div className="top-actions">
        ...
        <div className="top-user" ref={menuRef} onClick={() => setMenuOpen((v) => !v)}>
          ...
          <div>
            ...
            <span style={{ fontSize: 10.5, color: "var(--sub)" }}>{user?.medecin?.specialite?.nom ?? "Médecin"}</span>
          </div>
          <span style={{ color: "var(--sub)", fontSize: 12 }}>▾</span>
          {menuOpen && (
            <div className="user-menu">
              <Link to="/medecin/profil">👤 Mon profil</Link>
              <Link to="/medecin/parametres">⚙️ Paramètres</Link>
